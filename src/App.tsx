      ...
      {yesPressed ? (
        <>
          ...
          <audio controls className="my-4 w-full max-w-4xl">
            <source src="/will-you-be-my-valentine/Dance%20Gavin%20Dance%20-%20Death%20of%20a%20Strawberry.mp3" type="audio/mpeg" />
          ...
          <div className="my-4 w-full max-w-4xl">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4">
              ...
              <video controls src="/will-you-be-my-valentine/poze/14.mp4" className="w-full h-auto rounded-lg">Your browser does not support the video tag.</video>
              ...
              <video controls src="/will-you-be-my-valentine/poze/20.mp4" className="w-full h-auto rounded-lg">Your browser does not support the video tag.</video>
              ...
              <video controls src="/will-you-be-my-valentine/poze/25.mp4" className="w-full h-auto rounded-lg">Your browser does not support the video tag.</video>
              ...
              <video controls src="/will-you-be-my-valentine/poze/28.mp4" className="w-full h-auto rounded-lg">Your browser does not support the video tag.</video>
              ...
              <video controls src="/will-you-be-my-valentine/poze/42.mp4" className="w-full h-auto rounded-lg">Your browser does not support the video tag.</video>
              <video controls src="/will-you-be-my-valentine/poze/43.mp4" className="w-full h-auto rounded-lg">Your browser does not support the video tag.</video>
        ...
        <>
          <img
            ...
            alt="Cute Love Bear"
          />
          <h1 className="my-4 text-4xl text-center">Will you ALWAYS be mine?</h1>
